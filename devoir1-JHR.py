### BONJOUR CLÉMENCE, ICI JEAN-HUGUES ROY
...
# Réussi ! ### BRAVO D'AVOIR DEMANDÉ DE L'AIDE, AUSSI! C'EST TRÈS JOURNALISTIQUE COMME DÉMARCHE. DANS LE DOUTE, ON VÉRIFIE! :)
# Je mettrai tous mes essais en commentaire 
...
# Cela me dit la même chose. Quatrième essai : 
...
# être venue vous voir pour que vous m'expliquiez, voici le résultat : 
...
### SUPER COMMENTAIRES QUI ME PERMETTENT DE VOIR TA DÉMARCHE ET TES RÉFLEXIONS
### TU ÉTAIS TRÈS PROCHE DU BUT. BRAVO D'AVOIR COMPLÉTÉ EN DEMANDANT UN COUP DE MAIN.